...
class AssetStrategico:
    ...
    def __init__(
        self, id=None, nome="Generico", rischio=0.0, company_id="GENERIC_CORP", **kwargs
    ):
        self.id = id
        self.nome = nome
...
class AssetDiMercato(AssetStrategico):
    ...
    def __init__(self, **kwargs):
        ...
        self.quantita = kwargs.get(
            "quantita", kwargs.get("Quantita", kwargs.get("Pezzi", 0))
        )
...
class AssetDiValore(AssetStrategico):
    ...
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.prezzo = kwargs.get(
            "prezzo", kwargs.get("Importo", kwargs.get("Costo_Unitario", 0.0))
        )
        self.stato_pagamento = kwargs.get(
            "stato", kwargs.get("Stato_Qualita", kwargs.get("Condizione", "In attesa"))
        )
...
class AssetDiRelazione(AssetStrategico):
    ...
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.partner = kwargs.get(
            "Fornitore_Origine",
            kwargs.get("Cliente", kwargs.get("Ragione_Sociale", "Privato")),
        )
